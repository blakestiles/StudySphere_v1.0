    ...
    <div className="p-8">
      ...
      {!success ? (
        ...
        <div className="text-center py-4 space-y-4">
          ...
          <Link
            href="/login"
            className="inline-block text-sm font-medium text-amber-600 dark:text-amber-400 hover:text-amber-500 transition-colors underline-offset-4 hover:underline"
          >
